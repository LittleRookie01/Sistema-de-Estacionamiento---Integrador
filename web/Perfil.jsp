...
<%
        ...
        correo = (String) sesionOk.getAttribute("correo");
                            ...
                            <div class="card-body">
                                <div class="row form-group">                                                                    
                                    <div class="col-md-6">
                                        ...
                                        <p>DNI: <samp class="copy_active"> <%= dni  %> </samp></p>
                                        <p>Usuario: <samp class="copy_active"> <%= usuario  %> </samp></p>
                                        <p>Correo:<samp class="copy_active"> <%=correo%> </samp></p>                                        
                                    </div>
                                                                                                                          
                                    <div class="col-md-6">
                                        <img src="IMG/userIcon.png" width="250px" height="250px" alt="alt"/>
                                    </div>
      ...
      <div class="modal-body">
              ...
              <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control" name="email" value="<%=correo%>">
                        </div>
                        <div class="mb-4">
                            <label for="text" class="form-label">Rol</label>
                            <input type="text" class="form-control" disabled="" value="<%= cargo %>">
                        </div>
