                ...
                <div class="containe-fluid">
                    <div class="row mt-3 mb-3 pl-5 pr-5">
                        <div class="col-md-4 offset-md-2">
                            <!-- Caja de "Total De Vehículos Ingresados" -->
                        ...
                        <div class="col-md-4">
                            <!-- Caja de "Total de Vehículos Salientes" -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 offset-2">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th class="text-center" colspan="4">Tienes una Reserva para el dia:</th>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" colspan="1"> Fecha: ##### </td>
                                                    <td class="text-center" colspan="2"> Vehiculo: @@@@@@ </td>
                                                    <td class="text-center" colspan="1"> Placa: ##### </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" colspan="1"> Hora de entrada:###### </td>
                                                    <td class="text-center" colspan="3"> Hora de Salida:###### </td>
                                                </tr>
                                                <tr>
                                                    <th class="text-center" colspan="4">Cantidad de Reservas Realizadas</th>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" colspan="4">#####</td>
                                                </tr>
                                                <tr>
                                                    <th class="text-center" colspan="4">Cantidad de Reservas Registrados</th>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" colspan="4">#####</td>
                                                </tr>
                                                <tr>
                                                    <th class="text-center" colspan="4">Vehículo mas Utilizado</th>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" colspan="2"> Nombre: @@@@@ </td>
                                                    <td class="text-center" colspan="2"> Placa: ##### </td>
                                                </tr>
