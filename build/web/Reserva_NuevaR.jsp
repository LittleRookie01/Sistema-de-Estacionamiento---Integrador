                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2 col-lg-3">
                                    <label>Mis Vehiculos</label> <br>
                                    
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Seleccione el vehiculo a reservar</option>
<%
                            ArrayList<MisVehiculos> lista = (ArrayList<MisVehiculos>) request.getAttribute("lista");                            
                            for (int i = 0; i < lista.size(); i++) {
                                MisVehiculos mv = lista.get(i);                                
                        %>                                        
                                        <option value="<%= mv.getPlaca()%>"><%= mv.getNombre()%> - "<%= mv.getPlaca()%>"
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <%
                                            if (es.getEs_estado().equals("Disponible")) {                                                                                                    
                                        %>                                         
                                        <i class="fas fa-car" style="font-size: 100px; color: green"></i>                                        
                                    <%
                                            }else{                                                                                                    
                                        %>
                                        <i class="fas fa-car" style="font-size: 100px; color: red"></i> 
                                        <% } %>                                         
                                        <p> <%= es.getEs_nombre()%> </p>
                                    </td>
                                    <% } %> 
